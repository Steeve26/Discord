...
function App() {
  ...
  const servers = [
    ...
    {name: 'lofi girl', icon: 'https://cdn.discordapp.com/icons/707230275175841915/88f72bfe21ebc52b4aace3ab34b8593d.webp?size=128', iconType: 'image', background: '', notifications: '', hoverColor: '', type: '', banner: lofiGirl}, 
